...
final class AppStore {
    ...
    var availableAgentObjects: [OpenCodeAgent] = []
    var ephemeralAgentModels: [String: String] = [:]
    var preferredFallbackModelID: String?
    var lastThinkingLevelByModelID: [String: String] = [:]
    ...
    let gitRefreshFallbackInterval: Duration = .seconds(300)
    let gitCommitPreviewRetryDelays: [Duration] = [.milliseconds(150), .milliseconds(500)]
    ...
    var gitRefreshDebounceTask: Task<Void, Never>?
    ...
    var gitStateByProjectPath: [String: GitCachedState] = [:]
    var gitOperationStateByProjectPath: [String: GitOperationState] = [:]
    ...
    func persistComposerStateForSelectedSession() {
